...
--	@Insert_Group = 'y',
--		@Group_ID = 89,
--		@Group_E = N'Soil, water and other forest ecosystem functions Subclass of MCPFE Class 3 (1000 ha)',
--	@Insert_ReportingForm = 'y', 
--		@ReportingForm_ID = 32,
--		@ReportingForm_E = N'Form 5.1: Protective forests – soil, water and other ecosystem functions',
--	@Subgroup_ID = 1,
--	@DIMENSION_ID = N'0',
--	@TERM_NAME = N'Forest/Soil&Water',
--	@STATE_STRUCTURE_NAME = N'F5.1';
--
--EXECUTE usp_INSERT_Total_Full_McpfeDb_2011
--	@Insert_Topic = 'n',
--		@Topic_ID = 3,
...
--	@Subgroup_ID = 1,
--	@DIMENSION_ID = N'0',
--	@TERM_NAME = N'FOWL/Soil&Water',
--	@STATE_STRUCTURE_NAME = N'F5.1'; --Backed up at 12:30
...
EXECUTE usp_INSERT_Total_Full_McpfeDb_2011
	...
	@Subgroup_ID = 1,
	@DIMENSION_ID = N'0',
	@TERM_NAME = N'Forest/Nat2000 soil&water',
	@STATE_STRUCTURE_NAME = N'F5.1';
...
EXECUTE usp_INSERT_Total_Full_McpfeDb_2011
	...
	@Subgroup_ID = 1,
	@DIMENSION_ID = N'0',
	@TERM_NAME = N'OWL/Nat2000 soil&water',
	@STATE_STRUCTURE_NAME = N'F5.1';
...
EXECUTE usp_INSERT_Total_Full_McpfeDb_2011
	...
	@Subgroup_ID = 1,
	@DIMENSION_ID = N'0',
	@TERM_NAME = N'FOWL/Nat2000 soil&water',
	@STATE_STRUCTURE_NAME = N'F5.1'; --Backed up at 12:30
